...
return [
    'plugin' => [
        'name' => 'Img Resizer',
        'description' => 'Изменение размеров картинок на лету'
    ],
    'settings' => [
        'label' => 'Img Resizer',
        'description' => 'Настройка плагина',
        'tab_default' => 'Основные',
        'tab_advanced' => 'Расширенные',
        'not_found_image_label' => 'Картинка 404',
        'not_found_image_comment' => 'Если изображение не найдено будет отображаться Картинка 404',
